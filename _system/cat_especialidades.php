...
<style>
    ...
    @media (max-width: 640px) {
        ...
        .specialties-section { padding: 18px; }
...
<div class="dashboard-container">
    ...
    <div class="page-header">
        <div class="header-title">
            ...
            <div>
                ...
                <span>Gestión de especialidades médicas</span>
            </div>
        </div>
        <div class="update-badge">
            <i class="icofont icofont-doctor"></i> Administración
        </div>
    </div>
    ...
    <div class="specialties-section">
        <div class="section-header">
            <h5><i class="icofont icofont-list"></i> Lista de especialidades</h5>
            <button class="btn-modern" data-toggle="modal" data-target="#modalAgregarEspecialidad">
                <i class="ti-plus"></i> Agregar Especialidad
            </button>
        </div>

        <div class="modern-table-wrapper">
            <table id="tbl_especialidades" class="table-modern" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
            ...
            columns: [
                ...
                { data: 'descripcion' },
                {
                    ...
                    render: function(data, type, row) {
                        if (data == 1) {
                            return '<span class="badge-success-modern">Activo</span>';
                        } else {
                            return '<span class="badge-danger-modern">Inactivo</span>';
                        }
                    }
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        var id = escapeHtmlStatic(row.id_especialidad);
                        var nombre = escapeHtmlStatic(row.nombre);
                        var descripcion = escapeHtmlStatic(row.descripcion);
                        var activo = escapeHtmlStatic(row.activo);
                        return `
                            <button class="btn-action" data-toggle="modal" data-target="#modalEditarEspecialidad" title="Editar especialidad" 
                                onclick="editarEspecialidad('${id}', '${nombre}', '${descripcion}', '${activo}')">
