...
<div class="dashboard-container">
    ...
    <div class="page-header">
        <div class="header-title">
            ...
            <div>
                <h4>Catálogo de Consultorios y Salas</h4>
                <span>Gestión de espacios médicos</span>
            </div>
        </div>
        <div class="update-badge">
            <i class="icofont icofont-building"></i> Administración
        </div>
    </div>
    ...
    <div class="rooms-section">
        <div class="section-header">
            <h5><i class="icofont icofont-list"></i> Lista de consultorios</h5>
            <button class="btn-modern" data-toggle="modal" data-target="#modalAgregarConsultorio">
                <i class="ti-plus"></i> Agregar Consultorio
            </button>
        </div>

        <div class="modern-table-wrapper">
            <table id="tbl_consultorios" class="table-modern" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Número/Sala</th>
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        const id = escapeHtmlStatic(row.id_consultorio);
                        const numeroSala = escapeHtmlStatic(row.numero_sala || '');
                        const ubicacion = escapeHtmlStatic(row.ubicacion || '');
                        ...
                        return `
                            <button class="btn-action" data-toggle="modal" data-target="#modalEditarConsultorio"
                                onclick="editarConsultorio('${id}','${numeroSala}','${ubicacion}','${activo}')">
                                <i class="ti-pencil"></i> Editar
                            </button>
                            <button class="${claseToggle}" onclick="toggleConsultorio('${id}','${nuevoEstado}')">
